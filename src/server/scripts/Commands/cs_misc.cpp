...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> commandTable =
        {
            ...
            { "send",               SEC_GAMEMASTER,         CMD_CLI,  NULL,                                "", sendCommandTable },
            { "pet",                SEC_GAMEMASTER,         CMD_INGAME, NULL,                                "", petCommandTable },
            ...
            { "group",              SEC_ADMINISTRATOR,      CMD_INGAME, NULL,                                "", groupCommandTable },
