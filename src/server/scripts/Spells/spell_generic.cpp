...
{
public:
    spell_sleep_magic_dust() : SpellScriptLoader("spell_sleep_magic_dust") { }
...
{
public:
    spell_gen_cleansing_vial() : SpellScriptLoader("spell_gen_cleansing_vial") { }
    ...
    class spell_gen_cleansing_vial_SpellScript : public SpellScript
    {
        ...
        void HandleSendEvent(SpellEffIndex effIndex)
        {
            if (Unit* caster = GetCaster())
            {
                float x = 426.15f; float y = 3461.03f; float z = 63.4f; float o = 3.14f;
