    ...
    { 
        ...
        if (challenger->isInGamblingArea() || target->isInGamblingArea())
        {
            if (challenger->hasGoldDuelSetting50G())
            {
                ...
                ChatHandler(target->GetSession()).PSendSysMessage("|cffff0000[PvP] You will be dueling for 50 gold with %s! Do you accept that?", challenger->GetName().c_str());
            }
            else if (challenger->hasGoldDuelSetting100G())
            {
                ...
                ChatHandler(target->GetSession()).PSendSysMessage("|cffff0000[PvP] You will be dueling for 100 gold with %s! Do you accept that?", challenger->GetName().c_str());
            }
            else if (challenger->hasGoldDuelSetting200G())
            {
                ...
                ChatHandler(target->GetSession()).PSendSysMessage("|cffff0000[PvP] You will be dueling for 200 gold with %s! Do you accept that?", challenger->GetName().c_str());
            }
            else if (challenger->hasGoldDuelSetting500G())
            {
                ...
                ChatHandler(target->GetSession()).PSendSysMessage("|cffff0000[PvP] You will be dueling for 500 gold with %s! Do you accept that?", challenger->GetName().c_str());
            }
            else if (challenger->hasGoldDuelSetting1000G())
            {
                ...
                ChatHandler(target->GetSession()).PSendSysMessage("|cffff0000[PvP] You will be dueling for 1000 gold with %s! Do you accept that?", challenger->GetName().c_str());
            }
        }
    }
