...
class spell_deathbringer_blood_link_AuraScript : public AuraScript
{
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        switch (procSpell->Id) // some spells give more Blood Power
        {
            ...
            case 72409: case 72447: case 72448: case 72449: // Rune of Blood
                basepoints = 5;
                break;
            case 72385: case 72441: case 72442: case 72443: // Boiling Blood
                basepoints = 2;
                break;
        }
...
{
    npc_king_wrynn_saurfang_iccAI(Creature* creature) : ScriptedAI(creature) { }
...
{
public:
    npc_saurfang_peon() : CreatureScript("npc_saurfang_peon") { }

    struct npc_saurfang_peonAI : public ScriptedAI
    {
        npc_saurfang_peonAI(Creature* creature) : ScriptedAI(creature) {
            _instance = me->GetInstanceScript();
        }
...
{
public:
    npc_saurfang_vendor() : CreatureScript("npc_saurfang_vendor") { }
