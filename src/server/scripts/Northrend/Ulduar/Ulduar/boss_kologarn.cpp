...
public:
    ...
    struct boss_kologarnAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.RescheduleEvent(EVENT_SMASH, 8000, 1);
            events.RescheduleEvent(EVENT_SWEEP, 17000, 1);
            events.RescheduleEvent(EVENT_GRIP, 15000, 1);
            events.RescheduleEvent(EVENT_FOCUSED_EYEBEAM, 25000, 1);
    ...
    struct boss_kologarn_armsAI : public ScriptedAI
    {
        ...
        void PassengerBoarded(Unit* who, int8 seatId, bool apply)
        {
            ...
            else
            {
                ...
                if (!_damageDone)
                    _damageDone = RAID_MODE(150000, 450000);
            }
        }
