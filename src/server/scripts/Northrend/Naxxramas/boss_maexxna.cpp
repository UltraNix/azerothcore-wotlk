        ...
        void UpdateAI(uint32 diff)
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_SPELL_POISON_SHOCK:
                    ...
                    events.RepeatEvent(sWorld->getBoolConfig(CONFIG_BOOST_NAXXRAMAS) ? RAID_MODE(40000, 10000) : 40000);
                    break;
                ...
                case EVENT_WEB_WRAP:
                    ...
                    for (uint8 i = 0; i < RAID_MODE(1, sWorld->getBoolConfig(CONFIG_BOOST_NAXXRAMAS) ? 4 : 2); ++i)
                    {
                    ...
                    events.RepeatEvent(sWorld->getBoolConfig(CONFIG_BOOST_NAXXRAMAS) ? RAID_MODE(40000, 25000) : 40000);
                    break;
            }
