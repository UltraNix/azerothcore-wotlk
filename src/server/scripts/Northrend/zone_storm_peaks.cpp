...
public:
    ...
    {
        npc_roaming_jormungarAI(Creature* creature) : ScriptedAI(creature) {}

        bool questCredit;

        void Reset() { questCredit = false; }
...
public:
    ...
    struct npc_time_lost_proto_drakeAI : public npc_escortAI
    {
        ...
        void RollPath()
        {
            ...
            me->UpdateEntry(roll_chance_i(15) ? NPC_TIME_LOST_PROTO_DRAKE : NPC_VYRAGOSA, 0, false);
        }
