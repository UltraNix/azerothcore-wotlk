    ...
    struct boss_nightbaneAI : public BossAI
    {
        ...
        void DoAction(int32 action) override
        {
            if (action == ACTION_SUMMON)
            {
                ...
                //me->GetMotionMaster()->MoveAlongSplineChain(POINT_INTRO_START, SPLINE_CHAIN_INTRO_START, false); @todo port
        ...
        {
            if (type == /*SPLINE_CHAIN_MOTION_TYPE*/ 255) // @todo port
            {
                switch (pointId)
                {
        ...
        void ExecuteEvent(uint32 eventId) override
        {
            switch (eventId)
            {
                ...
                case EVENT_END_INTRO:
                    //me->GetMotionMaster()->MoveAlongSplineChain(POINT_INTRO_LANDING, SPLINE_CHAIN_INTRO_LANDING, false); @todo port
                    break;
                case EVENT_END_PHASE_TWO:
                    //me->GetMotionMaster()->MoveAlongSplineChain(POINT_PHASE_TWO_LANDING, SPLINE_CHAIN_SECOND_LANDING, false); @todo port
                    break;
                ...
                case EVENT_LAND:
                    ...
                    me->SetDisableGravity(true);
                    //me->GetMotionMaster()->MoveAlongSplineChain(POINT_PHASE_TWO_END, SPLINE_CHAIN_PHASE_TWO, false); @todo port
                    break;
                case EVENT_LANDED:
                    SetupGroundPhase();
                ...
                case EVENT_START_INTRO_PATH:
                    //me->GetMotionMaster()->MoveAlongSplineChain(POINT_INTRO_END, SPLINE_CHAIN_INTRO_END, false); @todo port
                    break;
