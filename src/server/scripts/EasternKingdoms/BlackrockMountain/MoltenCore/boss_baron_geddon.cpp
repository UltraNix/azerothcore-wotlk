...
class spell_inferno : public SpellScriptLoader
{
    public:
        spell_inferno() : SpellScriptLoader("spell_inferno") { }
        ...
        {
            return new spell_infernoAuraScript();
        }
};
