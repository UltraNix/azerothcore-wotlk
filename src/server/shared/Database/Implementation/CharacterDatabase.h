...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_UPD_LOOT_SYSTEM_ITEM_COUNT_CRE,
    CHAR_INS_LOOT_SYSTEM_ITEM,
    CHAR_DEL_LOOT_SYSTEM_CREATURE_LOOT,
    CHAR_DEL_LOOT_SYSTEM_ITEM,
    CHAR_DEL_LOOT_SYSTEM_LOOT,
    // BAZAR
    CHAR_UPD_MONEY_AMOUNT,
    CHAR_INS_BAZAR_AUCTION,
    CHAR_DEL_BAZAR_AUCTION,
    CHAR_DEL_BAZAR_AUCTION_BY_GUID,
    CHAR_SEL_BAZAR_AUCTION_COUNT,
    CHAR_SEL_BAZAR_AUCTION_TIME,
    CHAR_SEL_BAZAR_AUCTION_OWNER,
    CHAR_SEL_BAZAR_AUCTION_OWNER_AUCTIONS,
    CHAR_SEL_BAZAR_AUCTION_AMOUNT,
    CHAR_SEL_BAZAR_AUCTION_AMOUNT_EFFORT,
    CHAR_SEL_BAZAR_AUCTION_AMOUNT_OFFER,
    CHAR_UPD_BAZAR_AUCTION_OWNER_NAME,
    CHAR_SEL_BAZAR_AUCTION_TYPE,
    // SLAVE
    CHAR_UPD_SLAVE_ACCOUNT_ID,
    CHAR_DEL_SLAVE_CHAR_ACHIEVEMENT,
    // NINJA LOOTERS
    CHAR_SEL_NINJA_LOOTER_GUID_CHECK,
    CHAR_SEL_NINJA_LOOTER,
    CHAR_UPD_NINJA_LOOTER,
    // GAMBLING
