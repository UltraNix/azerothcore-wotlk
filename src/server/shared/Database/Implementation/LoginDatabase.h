...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_SEL_PREMIUM_ID,
    LOGIN_DEL_PREMIUM_ID,
    LOGIN_REP_ACCOUNT_PREMIUM,
    LOGIN_SEL_PREMIUM_TIME_BY_ID,
    LOGIN_UPD_PREMIUM_POINTS,
    LOGIN_UPD_PREMIUM_POINTS_REMOVE,
    LOGIN_SEL_PREMIUM_POINTS,
    LOGIN_REP_ACCOUNT_HISTORY,
    LOGIN_SEL_ACCOUNT_HISTORY_BY_ID,
    LOGIN_SEL_ACCOUNT_HISTORY_BY_IP,
    LOGIN_INS_INGAME_STATISTICS,
    LOGIN_SEL_IP2NATION,
    LOGIN_SEL_IP2NATION_COUNT,
    LOGIN_GET_IP2NATION_PLAYER_IP,
    LOGIN_REP_MUTE_HISTORY,
    LOGIN_SEL_MUTE_HISTORY,
    LOGIN_SEL_VPN,
    LOGIN_SEL_PREMIUM_SERVICES,
