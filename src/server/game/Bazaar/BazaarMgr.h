...
class BazaarMgr
{
    ...
    public:
        ...
        bool CreateBazaarAuction(Player* player, uint32 moneyAmount, uint32 dpAmount, uint8 type, uint8 mainSpec, uint8 offSpec, uint16 gearScore, std::string description);
