...
class Unit : public WorldObject
{
    public:
        ...
        uint8 getRace( bool allowOverride = true ) const;
        uint32 getRaceMask( bool allowOverride = true ) const { return 1 << (getRace( allowOverride )-1); }
        ...
        void CalculateMeleeDamage(Unit* victim, uint32 damage, CalcDamageInfo* damageInfo, WeaponAttackType attackType = BASE_ATTACK, bool forceCrit = false);
