...
class Unit : public WorldObject
{
    public:
        ...
        //! @Riztazz: removeTargetingAreaAuras added by me, i think it shouldnt remove persitent area auras at all in any case
        //! but we will see in the future if anything else needs a change like this, if so then we should make it default for all cases
        void RemoveMovementImpairingAuras(bool withRoot, bool removeTargetingAreaAuras = true);
