...
m_cannotReachTarget(false), m_cannotReachTimer(0), m_disableChangeAI(false), m_respawnRate(1.0f), m_chainPullEnabled(false), m_shouldBeHealedAtEvade(true)
{
...
void Creature::SendZoneUnderAttackMessage(Player* attacker)
{
    ...
    sWorld->SendGlobalMessage(&data, NULL, (attacker->GetTeam() == TEAM_ALLIANCE ? TEAM_HORDE : TEAM_ALLIANCE));
}
