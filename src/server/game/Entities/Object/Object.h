...
class Object
{
    public:
        ...
        bool IsUnit() { return GetTypeId() == TYPEID_UNIT || GetTypeId() == TYPEID_PLAYER; }
        ...
        bool IsCorpse() { return GetTypeId() == TYPEID_CORPSE; }

        DynamicObject* ToDynObject() { if (GetTypeId() == TYPEID_DYNAMICOBJECT) return reinterpret_cast<DynamicObject*>(this); else return NULL; }
        DynamicObject const* ToDynObject() const { if (GetTypeId() == TYPEID_DYNAMICOBJECT) return reinterpret_cast<DynamicObject const*>(this); else return NULL; }
        bool IsDynamicObject() { return GetTypeId() == TYPEID_DYNAMICOBJECT; }
...
class WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        bool GetClosePoint(float &x, float &y, float &z, float size, float distance2d = 0, float angle = 0, const WorldObject* forWho = NULL, bool force = false, bool additionalHeightCheck = true) const;
