...
void WorldSession::HandleQuestgiverStatusQueryOpcode(WorldPacket & recvData)
{
    ...
    if (!questGiver)
    {
        sLog->outChinaTown("Error in CMSG_QUESTGIVER_STATUS_QUERY, called for not found questgiver (Typeid: %u GUID: %u)", GuidHigh2TypeId(GUID_HIPART(guid)), GUID_LOPART(guid));
        return;
    }
    ...
    switch (questGiver->GetTypeId())
    {
        case TYPEID_UNIT:
        {
            sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_STATUS_QUERY for npc, guid = %u", uint32(GUID_LOPART(guid)));
        ...
        {
            sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_STATUS_QUERY for GameObject guid = %u", uint32(GUID_LOPART(guid)));
            questStatus = _player->GetQuestDialogStatus(questGiver);
            break;
        }
        default:
...
void WorldSession::HandleQuestgiverHelloOpcode(WorldPacket & recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_HELLO npc = %u", GUID_LOPART(guid));

    Creature* creature = GetPlayer()->GetNPCIfCanInteractWith(guid, UNIT_NPC_FLAG_NONE);
    if (!creature)
    {
        sLog->outChinaTown("WORLD: HandleQuestgiverHelloOpcode - Unit (GUID: %u) not found or you can't interact with him.",
        GUID_LOPART(guid));
        return;
    }
...
void WorldSession::HandleQuestgiverAcceptQuestOpcode(WorldPacket & recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_ACCEPT_QUEST npc = %u, quest = %u, unk1 = %u", uint32(GUID_LOPART(guid)), questId, unk1);
...
void WorldSession::HandleQuestgiverQueryQuestOpcode(WorldPacket & recvData)
{
    ...
    uint8 unk1;
    recvData >> guid >> questId >> unk1;
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_QUERY_QUEST npc = %u, quest = %u, unk1 = %u", uint32(GUID_LOPART(guid)), questId, unk1);
...
void WorldSession::HandleQuestQueryOpcode(WorldPacket & recvData)
{
    ...
    uint32 questId;
    recvData >> questId;
    sLog->outChinaTown("WORLD: Received CMSG_QUEST_QUERY quest = %u", questId);
...
void WorldSession::HandleQuestgiverChooseRewardOpcode(WorldPacket & recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_CHOOSE_REWARD npc = %u, quest = %u, reward = %u", uint32(GUID_LOPART(guid)), questId, reward);
...
void WorldSession::HandleQuestgiverRequestRewardOpcode(WorldPacket & recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_REQUEST_REWARD npc = %u, quest = %u", uint32(GUID_LOPART(guid)), questId);
...
{
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_CANCEL");
...
void WorldSession::HandleQuestLogSwapQuest(WorldPacket& recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTLOG_SWAP_QUEST slot 1 = %u, slot 2 = %u", slot1, slot2);
...
void WorldSession::HandleQuestLogRemoveQuest(WorldPacket& recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTLOG_REMOVE_QUEST slot = %u", slot);
...
void WorldSession::HandleQuestConfirmAccept(WorldPacket& recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUEST_CONFIRM_ACCEPT quest = %u", questId);
...
void WorldSession::HandleQuestgiverCompleteQuest(WorldPacket& recvData)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_COMPLETE_QUEST npc = %u, quest = %u", uint32(GUID_LOPART(guid)), questId);
...
{
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_QUEST_AUTOLAUNCH");
}
...
void WorldSession::HandlePushQuestToParty(WorldPacket& recvPacket)
{
    ...
    sLog->outChinaTown("WORLD: Received CMSG_PUSHQUESTTOPARTY quest = %u", questId);
...
void WorldSession::HandleQuestPushResult(WorldPacket& recvPacket)
{
    ...
    sLog->outChinaTown("WORLD: Received MSG_QUEST_PUSH_RESULT");
...
{
    sLog->outChinaTown("WORLD: Received CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY");
