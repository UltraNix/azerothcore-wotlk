...
enum WorldBoolConfigs
{
    ...
    CONFIG_ARENA_AUTO_FLUSH_ENABLE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ARENA_AUTO_FLUSH_ENABLE_DAY,
    CONFIG_ARENA_AUTO_FLUSH_ENABLE_HOUR,
    CONFIG_ARENA_AUTO_FLUSH_ENABLE_MINUTE,
    ...
    CONFIG_MAX_RATE_XP_1_67,
    CONFIG_MAX_RATE_XP_68,
    ...
    CONFIG_WARDEN_LUA_MINIMUM_PLAYER_LEVEL,
...
class World
{
    ...
    private:
        ...
        typedef std::unordered_map<uint8, std::string> AutobroadcastsCountryMap;
        AutobroadcastsCountryMap m_AutobroadcastsCountry;

        typedef std::unordered_map<uint8, std::string> AutobroadcastsExceptCountryMap;
