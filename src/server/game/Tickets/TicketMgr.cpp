...
GmTicket::GmTicket(Player* player) : _createTime(time(nullptr)), _lastModifiedTime(time(nullptr)), _closedBy(0), _assignedTo(0), _completed(false), _escalatedStatus(TICKET_UNASSIGNED), _viewed(false), _needMoreHelp(false)
{
