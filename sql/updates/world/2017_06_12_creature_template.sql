...
-- 25 man
UPDATE `creature_template` SET `mindmg`=600, `maxdmg`=700, `dmg_multiplier`=10 WHERE `entry`=36566;
UPDATE `creature_template` SET `mindmg`=5400, `maxdmg`=5600, `dmg_multiplier`=10 WHERE `entry`=36571;
