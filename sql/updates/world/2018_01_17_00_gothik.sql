...
-- creature (13 entries)
SET @CGUID = 300000; -- PR NOTE: This needs to match the value set in boss_gothik.cpp for the CGUID_TRIGGER const
...
(16060,0,0,"Foolishly you have sought your own demise.",14,100,8807,3,"Gothik SAY_INTRO_1"),
(16060,1,0,"Brazenly you have disregarded powers beyond your understanding.",14,100,0,3,"Gothik SAY_INTRO_2"),
(16060,2,0,"You have fought hard to invade the realm of the harvester.",14,100,0,3,"Gothik SAY_INTRO_3"),
(16060,3,0,"Now there is only one way out- to walk the lonely path of the damned.",14,100,0,3,"Gothik SAY_INTRO_4"),
(16060,4,0,"I have waited long enough. Now you face the harvester of souls.",14,100,8808,3,"Gothik SAY_PHASE_TWO"),
(16060,5,0,"I... am... undone.",14,100,8805,3,"Gothik SAY_DEATH"),
(16060,6,0,"Death is the only escape!",14,20,8806,3,"Gothik SAY_KILL"),
(16060,7,0,"%s teleports into the fray!",41,100,0,3,"Gothik EMOTE_PHASE_TWO"),
(16060,8,0,"The central gate opens!",41,100,0,3,"Gothik EMOTE_GATE_OPENED");
