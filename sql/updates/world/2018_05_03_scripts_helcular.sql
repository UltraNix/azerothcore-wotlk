...
(1767,1,0,0,20,0,100,0,553,0,0,0,12,2433,3,60000,0,0,0,8,0,0,0,-742.94,-615.67,18.72,1.61731,"Helcular's Grave - On Quest 'Helcular's Revenge (Part 2)' Rewarded - Summon Creature 'Helcular's Remains'");
...
UPDATE `creature_text` SET `Emote`=15 WHERE `entry`=2433 AND `GroupID`=0;
UPDATE `creature_text` SET `Emote`=0 WHERE `entry`=2433 AND `GroupID`=1;
DELETE FROM `creature_text` WHERE `entry`=2433 AND `GroupID`=0 AND `ID`=3;
DELETE FROM `creature_text` WHERE `entry`=2433 AND `GroupID`=1 AND `ID`=1;
INSERT INTO `creature_text` (`entry`, `GroupID`, `ID`, `Text`, `Type`, `Language`, `Probability`, `Emote`, `Duration`, `Sound`, `TextRange`, `comment`) VALUES
(2433,0,3,"I returned from the grave to take my revenge!",14,0,100,15,0,0,0,"Helcular's Remains"),
(2433,1,1,"Die in the name of the Dark Lady, $n.",14,0,100,0,0,0,0,"Helcular's Remains");
