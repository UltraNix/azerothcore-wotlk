...
DELETE FROM `creature_text` WHERE `id` IN (14850, 14859);
INSERT INTO `creature_text` (`entry`, `GroupID`, `ID`, `Text`, `Type`, `Language`, `Probability`, `Emote`, `Duration`, `Sound`, `Comment`) VALUES 
-- Gruk
(14850, 0, 0, 'Would you like something more to eat sir?', 12, 0, 100, 1, 0, 0, 'Gruk'),
(14850, 1, 0, 'Right away sir.', 12, 0, 100, 1, 0, 0, 'Gruk'),
(14850, 2, 0, 'Here is your bread sir.', 12, 0, 100, 1, 0, 0, 'Gruk'),
(14850, 3, 0, 'As you wish sir.', 12, 0, 100, 1, 0, 0, 'Gruk'),
-- Guard Taruc
(14859, 0, 0, 'More bread boy!', 12, 0, 100, 1, 0, 0, 'Guard Taruc'),
(14859, 1, 0, 'Aaahh... Very good. Now scat!', 12, 0, 100, 1, 0, 0, 'Guard Taruc');
