UPDATE `creature_text` SET `Emote`=5 WHERE `entry`=7053 AND `GroupID`=2;
UPDATE `creature_text` SET `Emote`=11 WHERE `entry`=7053 AND `GroupID`=1;
DELETE FROM `creature_text` WHERE `entry`=7053 AND `GroupID`=5;
INSERT INTO `creature_text` (`entry`, `GroupID`, `ID`, `Text`, `Type`, `Language`, `Probability`, `Emote`, `Duration`, `Sound`, `TextRange`, `comment`) VALUES
(7053,5,0,"You cannot hide from me, rogue. I can smell your fear.",12,0,100,0,0,0,0,"Klaven Mortwake");
