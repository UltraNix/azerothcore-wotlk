-- DB/GameObject: Blastenheimer 5000 Ultra Cannon  Killyana
...
UPDATE `gameobject_template` SET `AIName`="SmartGameObjectAI", `faction` = 35 WHERE `entry` IN (180515, 180452,186560);
...
(111084, 15218, 0, 1, 1, 0, 0, -9570.283, -9.950684, 63.51959, 6.126106, 7200, 0, 0, 0, 0, 0, 0, 0, 0), 
(111094, 15218, 530, 1, 1, 0, 0, -1742.180, 5457.9300, -12.3448, 1.413720, 7200, 0, 0, 0, 0, 0, 0, 0, 0);
