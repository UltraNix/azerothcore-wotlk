...
DELETE FROM `creature` WHERE `id`  = 21455 AND `guid` = 106223;
DELETE FROM `creature` WHERE `id`  = 23148 AND `guid` = 106222;
...
(106223, 21455, 530, 1, 1, 1, -3422.27, 1122.06, 46.7247, 0.86922, 180, 0, 0),
