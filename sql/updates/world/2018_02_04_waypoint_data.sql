...
-- Love is in the Air NPC
UPDATE `creature` SET `MovementType` = 1, `spawndist` = 10 WHERE `guid` = 244500;
-- Devouring Ghoul
UPDATE `creature` SET `MovementType` = 1, `spawndist` = 15 WHERE `guid` IN (1978311, 1978107);