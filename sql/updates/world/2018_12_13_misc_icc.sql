...
-- Quests Should reward Emblems of Frost
...
DELETE FROM `creature` WHERE `guid` IN (101236, 133649);
INSERT INTO `creature` VALUES 
...
37627,
37677);
DELETE FROM `creature_loot_template` WHERE `item` = 47241 AND `entry` IN (
36476,
36494,
36497,
36498,
...
(36476, 47241, 100, 1, 0, 1, 1),                                          
(36494, 47241, 100, 1, 0, 1, 1),                                          
(36497, 47241, 100, 1, 0, 1, 1),                                          
(36498, 47241, 100, 1, 0, 1, 1),                                          
(36502, 47241, 100, 1, 0, 1, 1),                                          
(36658, 47241, 100, 1, 0, 1, 1),                                          
(36938, 47241, 100, 1, 0, 1, 1),                                          
(37613, 47241, 100, 1, 0, 1, 1),                                          
(37627, 47241, 100, 1, 0, 1, 1),
(37677, 47241, 100, 1, 0, 1, 1);
