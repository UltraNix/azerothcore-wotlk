...
UPDATE `creature_template` SET `ScriptName` = 'npc_nezraz' WHERE `entry` = 3149;
...
DELETE FROM `creature_text` WHERE `entry` IN (3149, 3150, 9566, 12137, 26539, 26540, 26538);
INSERT INTO `creature_text` (`entry`, `GroupID`, `ID`, `Text`, `Type`, `Language`, `Probability`, `Emote`, `Duration`, `Sound`, `TextRange`, `comment`) VALUES
(3149, 0, 0, "The zeppelin to Orgrimmar has just arrived! All aboard for Durotar!", 14, 0, 100, 0, 0, 0, 0, "Nez'raz"),
(3150, 0, 0, "The zeppelin to Grom'gol has just arrived! All aboard for Stranglethorn!", 14, 0, 100, 0, 0, 0, 0, "Hin Denburg"),
(9566, 0, 0, "The zeppelin to Orgrimmar has just arrived! All aboard for Durotar!", 14, 0, 100, 0, 0, 0, 0, "Zapetta"),
(12137, 0, 0, "The zeppelin to Undercity has just arrived! All aboard for Tirisfal Glades!", 14, 0, 100, 0, 0, 0, 0, "Squibby Overspeck"),
(26539, 0, 0, "The zeppelin to Vengeance Landing has just arrived! All aboard for Howling Fjord!", 14, 0, 100, 0, 0, 0, 0, "Meefi Farthrottle"),
(26540, 0, 0, "The zeppelin to Undercity has just arrived! All aboard for Tirisfal Glades!", 14, 0, 100, 0, 0, 0, 0, "Drenk Spannerspark"),
(26538, 0, 0, "The zeppelin to Orgrimmar has just arrived! All aboard for Durotar!", 14, 0, 100, 0, 0, 0, 0, "Nargo Screwbore");
