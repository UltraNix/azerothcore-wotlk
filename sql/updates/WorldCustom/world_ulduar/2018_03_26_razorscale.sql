...
(10314, 0, 0, 'We are ready to help!', 1, 1, 0, 0, 0, 0, '');
...
(33210,0,0,'Be on the lookout! Mole machines will be surfacing soon with those nasty Iron dwarves aboard!',14,0,100,0,0,0,0,'Expedition Commander SAY_AGGRO'),
(33210,1,0,'Move quickly! She won\'t remain grounded for long!',14,0,100,0,0,15648,0,'Expedition Commander SAY_GROUND_PHASE'),
(33210,2,0,'We have lost our engineers, this will not end well!',14,0,100,0,0,0,0,'Expedition Commander SAY_ENGINEERS_DEAD');

DELETE FROM `creature_text` WHERE `entry`=33186 AND `GroupID`=2;
INSERT INTO `creature_text` (`entry`,`GroupID`,`ID`,`Text`,`Type`,`Language`,`Probability`,`Emote`,`Duration`,`Sound`,`TextRange`,`comment`) VALUES
(33186,2,0,'%s goes into a berserker rage!',41,0,100,0,0,0,0,'Razorscale EMOTE_BERSERK');

/* ToDo, wyciagnac te teksty bo ich pewnie nie ma */
...
UPDATE `creature_template` SET `gossip_menu_id`=10314, `unit_flags` = 33280 WHERE `entry` IN (33210,34254); -- Expedition Commander
UPDATE `creature_template` SET `AIName` = "", `ScriptName` = "npc_expedition_commander" WHERE `entry` = 33210;
UPDATE `creature_template` SET `AIName` = "", `ScriptName`='npc_expedition_defender', `unit_flags` = 33280 WHERE `entry`=33816;
UPDATE `creature_template` SET `AIName` = "", `unit_flags` = 33280 WHERE `entry`=34255;
UPDATE `creature_template` SET `AIName` = "", `ScriptName`='npc_expedition_trapper', `unit_flags` = 33280 WHERE `entry`=33259;
UPDATE `creature_template` SET `AIName` = "",`unit_flags` = 33280 WHERE `entry`=34257;
UPDATE `creature_template` SET `AIName` = "", `ScriptName`='npc_expedition_engineer', `unit_flags` = 33280 WHERE `entry`=33287;
UPDATE `creature_template` SET `AIName` = "", `unit_flags` = 33280 WHERE `entry`=34256;
UPDATE `creature_template` SET `AIName` = "", `ScriptName`='npc_razorscale_spawner', `unit_flags` = 33554432 WHERE `entry`=33245;
UPDATE `creature_template` SET `AIName` = "", `ScriptName`='npc_razorscale_harpoon_fire_state', `unit_flags` = 33554432 WHERE `entry`=33282;
...
UPDATE `gameobject_template` SET `ScriptName` = "go_razorscale_harpoon" WHERE `entry` IN (194543, 194542, 194541, 194519);
...
UPDATE `creature` SET `position_x`=587.073, `position_y`=-203.205, `position_z`=441.237, `orientation`=1.972222 WHERE `guid`=137611; -- Razorscale
UPDATE `creature_template_addon` SET `path_id` = 1376110 WHERE `entry` = 33186;
