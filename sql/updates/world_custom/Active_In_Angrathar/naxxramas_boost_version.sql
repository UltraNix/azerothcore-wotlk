...
UPDATE `creature_template` SET `Health_mod` = @NEXUS_LORD_HP_BASE_MODIFIER + (@NEXUS_LORD_HP_BASE_MODIFIER * 0.5), `dmg_multiplier` = @NEXUS_LORD_BASE_DMG_25 * 2 WHERE `entry` = @NEXUS_LORD_25_ENTRY;
