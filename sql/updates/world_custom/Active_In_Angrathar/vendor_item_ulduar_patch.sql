...
-- PvP 
UPDATE `npc_vendor` SET `ExtendedCost` = 2692 WHERE `entry` IN (33915,33921) AND `item` IN (40866, 40868, 40963, 40869, 41038, 41044, 41211, 41217, 41275, 41281, 41715, 41683, 41869, 41934, 41965, 42011);
