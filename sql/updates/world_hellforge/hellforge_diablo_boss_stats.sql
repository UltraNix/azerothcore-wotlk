...
(156, 50000, 1.0, "Shadow step explosion damage"),
(157, 25000, 1.0, "Shadow step explosion radius ratio"),
(158, 50000, 1.0, "Napalam shell damage"),
...
(183, 50000, 1.0, "Armageddon damage"),
(184, 50000, 1.0, "Winds fall damage"),
(185, 10000, 1.0, "Spirit burn damage (siphon soul)"),
(186, 1, 1.1, "plasma ray width"),
(187, 8000, 1.0, "thundershock damage"),

/** demons **/
(200, 5, 1, "Demon shadow nova timer"),
(201, 8000, 1.0, "Demon shadow nova radius ratio"),
(202, 10000, 1.0, "Demon shadow nova damage"),
...
(216, 100000, 1.0, "comet hit damage"),
(217, 10000, 1.0, "meteor hit radius ratio"),
(218, 1, 1.0, "meteor hit target players only, 0 - false | 1 - true"),

/** infernal stats **/
(219, 2, 1.0, "Infernal hellfire first cast timer"),
(220, 50000, 1.0, "infenral hellfire damage"),
...
(225, 10000, 1.0, "flame buffet base damage"),
